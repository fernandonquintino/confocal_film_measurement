...
def map_garimella(df, FIG_WIDTH_CM=8.4, FIG_HEIGHT_CM=7.2):
    ...
    ax.grid(alpha=PLOT_STYLE["grid_alpha"], zorder=0)
    ...
    ax.legend(title="Flow pattern", bbox_to_anchor=(1, 1), loc="upper left", frameon=False)
